...
namespace zk_api {
  ...
  inline void xyz_control(float x, float y, float z, float power){
    int vec_fr =  (int)(255 * ( 0.707106781 * x - 0.707106781 * y + 0.5 * z));
    int vec_fl =  (int)(255 * (-0.707106781 * x - 0.707106781 * y + 0.5 * z));
    int vec_rl =  (int)(255 * (-0.707106781 * x + 0.707106781 * y + 0.5 * z));
    int vec_rr =  (int)(255 * ( 0.707106781 * x + 0.707106781 * y + 0.5 * z));
